...
import ayan from "../Images/Team/ayan.jpeg";
import Namrata from "../Images/Team/Namrata.jpg";
import aditya from "../Images/Team/aditya.jpeg";
            ...
            <h1 className='team-head'>Our Team</h1>
              <Row className="group">
               ...
               <Row className="group">
                <Col>
                    <div>
                        <img className='introImage' src={aditya} alt="aditya" />
                        <h4 className='member'>Aditya Nisal</h4>
                        <p>Web Developer</p>
                    </div>
                </Col>
                <Col>
               ...
               <Row>
                ...
                <Col>
                    <div>
                        ...
                        <h4 className='member'>Ayan Das</h4>
                        <p>Web Designer</p>
                    </div>
                </Col>
               </Row>
